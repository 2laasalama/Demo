    ...
    def price_unit_change(self):
        if self.order_id.pricelist_id:
            ...
            if self.order_id.pricelist_id and self.product_id \
                    and self.user_has_groups('restrict_saleprice_edit.groups_restrict_price_change') and not self.user_has_groups('restrict_saleprice_edit.groups_allow_sales_price_less_than_pricelist'):
